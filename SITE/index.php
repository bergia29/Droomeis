        ...
        echo '
            <div class="grid-item" data-category="' . htmlspecialchars($destination['categorie']) . '">
                ...
                <a href="destination.php?id=' . $destination['id'] . '">
                    <button class="price-bubble">À partir de ' . htmlspecialchars($destination['prix']) . '€</button>
                </a>
 ...
 <div class="grid-container">
    ...
    <div class="grid-item"data-category="randonnée désert artisanat desert">
      ...
      <div class="image-caption">
        ...
        <p class="caption">un lieu où les cheminées de fées, les paysages féériques et les montgolfières offrent un spectacle fascinant</p>
      </div>
...
<div class="grid-item hidden" data-category="ville musée randonnée"> 
    ...
    <div class="image-caption">
        ...
        <p class="caption">une ville où les vestiges impériaux, les fontaines emblématiques et l'âme éternelle de la capitale vous accueillent</p>
    </div>
...
<div class="grid-item hidden" data-category="ville musée randonnée desert">
    ...
    <div class="image-caption">
        ...
        <p class="caption">une ville où les pyramides majestueuses, les trésors antiques et l’effervescence des souks créent une expérience unique</p>
    </div>
    <button class="price-bubble">À partir de X€ TTC*</button>
    <button class="price-bubble1">♡</button>
...
<div class="grid-item hidden" data-category="safari randonnée circuit-détente"> 
    ...
    <div class="image-caption">
        ...
        <p class="caption">un village niché au cœur des Andes, entouré de sommets majestueux et de sentiers qui mènent à des merveilles naturelles</p>
    </div>
    <button class="price-bubble">À partir de X€ TTC*</button>
    <button class="price-bubble1">♡</button>
</div>
...
<div class="grid-item hidden" data-category="escalade mer artisanat randonnée circuit-détente"> 
    ...
    <div class="image-caption">
        ...
        <p class="caption">une île grecque authentique, célèbre pour ses falaises spectaculaires, ses eaux cristallines et son atmosphère paisible</p>
    </div>
    <button class="price-bubble">À partir de X€ TTC*</button>
    <button class="price-bubble1">♡</button>
</div>
