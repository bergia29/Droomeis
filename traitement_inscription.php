...
try {
    ...
    // Test simple
    // echo "Connexion réussie!"; // Décommentez ceci pour tester la connexion
} catch (Exception $e) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['email'], $_POST['password'], $_POST['nom'], $_POST['prénom'], $_POST['dateNaissance'], $_POST['adressePostale'], $_POST['role'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO `utilisateur` (emailU, passwordU, nomU, prénomU, dateNaissanceU, adressePostalU, role) 
                                VALUES (:email, :password, :nom, :prenom, :dateNaissance, :adressePostale, :role)");
